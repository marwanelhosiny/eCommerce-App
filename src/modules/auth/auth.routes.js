...
import { changepassSchema, forgetpasswordSchema, resetpassSchema, showprofileSchema, signinSchema, signupSchema, userupdateSchema } from "./auth.schemas.js";
...
router.post('/reset/:token', validationFunction(resetpassSchema), expressAsyncHandler(ac.resetPass))
